// Azure Static Web App module for @ana/admin (admin dashboard)
// Provides the admin interface for log viewing and template management

@description('The name prefix for the admin Static Web App')
...
// Variables
var staticWebAppName = '${appName}-admin'
...
resource staticWebApp 'Microsoft.Web/staticSites@2024-04-01' = {
  ...
  properties: {
    ...
    provider: 'Custom'
    buildProperties: {
      appLocation: 'static-web-apps/ana-admin'
      outputLocation: 'dist'
    }
  }
}
